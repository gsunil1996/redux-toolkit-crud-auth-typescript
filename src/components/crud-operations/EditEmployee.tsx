...
const EditEmployee = (props: EditEmployeeComponentProps) => {
  ...
  const { employeeEditDataLoading, employeeEditDataIsError, employeeEditDataError, employeeEditDataIsSuccess } = useAppSelector(
    (state) => state.employees
  );

  const employeeProfileData = useAppSelector(
    (state) => state.employees.employeeProfileData
  );
  const employeeProfileIsLoading = useAppSelector(
